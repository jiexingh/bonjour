...
const SectionDescription = () => {
  return (
    <section className='py-8 container tracking-wider mx-auto flex flex-col gap-6 items-center animate-slide-top [animation-delay:0.3s]'>
        <p className="text-2xl">Bounjour! 有一个<span className='text-highlight'>愿景</span></p>
        ...
        <div className="text-center">
            <p>而这份说明书的要素已被 <span className="text-highlight">隐藏性</span> 存放在互联网</p>
            <p>只是 <span className="text-highlight">被社交媒体分散各地</span></p>
            <p>导致你无法 <span className="text-highlight">快速、精准、完整</span> 地向外分享</p>
        </div>
