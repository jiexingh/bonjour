...
const PlatformIconCard: React.FC<PlatformIconCardProps> = ({ index, icon, name, desc, btnText, btnClassName}) => (
  <div className={` w-full flex flex-col gap-6 md:gap-10 lg:w-1/2 border rounded-3xl p-4 transform ${index % 2 === 1 ? '-rotate-6' : 'rotate-6'}`}>
    ...
    <div className='mt-8 container mx-auto w-full px-4 flex flex-col animate-slide-top [animation-delay:0.4s]'>
        ...
        <div className="grid grid-cols-2 md:gap-2">
            <div className="flex flex-col md:items-center gap-12 md:gap-16">
                ...
                <PlatformIconCard index={2} icon="/assets/logos/docker.svg" name='Docker' desc="Accelerate how you build, share, and run applications" btnText='使用' btnClassName='font-black border shadow-sm'/>
            ...
            <div className="relative flex flex-col gap-20 md:gap-24 justify-center md:items-center">
                <PlatformIconCard index={4} icon="/assets/logos/github.svg" name='GitHub Respository' desc="闪耀的开源精神" btnText='Star' btnClassName='bg-black text-white border'/>
