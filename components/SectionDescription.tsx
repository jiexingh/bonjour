...
const SectionDescription = () => {
  return (
    <section className='py-8 container mx-auto flex flex-col gap-6 items-center animate-slide-top [animation-delay:0.3s]'>
        ...
        <div className="text-center text-slate-600">
            <p>而这份说明书的要素已被 <span className="text-black">隐藏性</span> 存放在互联网</p>
            <p>只是<span className="text-black">被社交媒体分散各地</span></p>
            <p>导致你无法 <span className="text-black">快速、精准、完整</span> 地向外分享</p>
        </div>
